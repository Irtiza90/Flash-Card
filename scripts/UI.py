...
class UI:
    def __init__(self):
        ...
        self.yes_img = PhotoImage(file='../images/right.png')
        self.no_img = PhotoImage(file='../images/wrong.png')
        ...
        self.translate_from_label = Label(self.select_lang_frame, text='Translate From ', font=('Arial', 20),
                                          background='#91C2AF', foreground='white')

        self.translate_to_label = Label(self.select_lang_frame, text='Translate To ', font=('Arial', 20),
                                        background='#91C2AF',
                                        foreground='white')
