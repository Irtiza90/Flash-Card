...
class DataManager:
    ...
    def __init__(self):
        self.file_path = '../data/translations.csv'
        self.translate_from = ''
        self.translate_to = ''
    ...
    def find_all_languages() -> list:
        ...
        languages: list = pandas.read_csv('../data/languages.csv').Name
    ...
    def words_known(self, word_to_write: str) -> None:
        ...
        with open(f'../data/words-known/{self.translate_from}.txt', encoding='utf-8', mode='a') as f:
...
class Method:
    ...
    def get_words_known(self):
        ...
        with open(f'../data/words-known/{self.data_manager.translate_from}.txt', 'r', encoding='utf-8') as f:
